import num from "./01.basic";

//2
const apply:(a:number,b:number) => number = (a,b) => a+b;

 //2
export type PrintType = (name:string,favorlet:'돈까스'|'제육'|'치킨') => void
...
type FnType = ([first,...rest]) => Number[];
const fn:FnType  = ([first,...rest]:[Number,...Number[]]) => {
