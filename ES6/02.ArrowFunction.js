...
/*
    ...
    - this가 필요없는 함수를 간결하게 표현하고자 할 때
    - 상위 스코프의 this를 그대로 유지해야 하는 콜백함수를 사용 시
*/
function Timer(){
    this.seconds = 0;
...
// - 함수의 this를 첫 번쨰 인자인 thisargs변경한 후 호출.
user.printName.call({name:'Donald Trump'});

//2) apply(thisargs,[args])
// - call과 동일하지만, 두번쨰 인자를 배열로 받음.
...
const bindFn = user.printName.bind({name:'Donald Trump'});
bindFn();